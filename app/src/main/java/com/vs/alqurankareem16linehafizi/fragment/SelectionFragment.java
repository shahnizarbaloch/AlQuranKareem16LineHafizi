...
import com.vs.alqurankareem16linehafizi.databinding.FragmentSelectionBinding;
...
public class SelectionFragment extends Fragment {
    ...
    private void initialize() {
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                .add(getString(R.string.menu_1_surah), SurahFragment.class)
                .add(getString(R.string.menu_2_para), ParaFragment.class)/*
