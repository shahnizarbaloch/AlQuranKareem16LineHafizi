...
import com.vs.alqurankareem16linehafizi.adapters.SelectionParaAdapter;
import com.vs.alqurankareem16linehafizi.databinding.FragmentParahBinding;
...
import com.vs.alqurankareem16linehafizi.repositories.ParaRepo;
...
public class ParaFragment extends Fragment implements SelectionParaAdapter.OnMyOwnClickListener {
     ...
     */
    private void handleLikeButton(ParaRoom obj, int position) {
        ...
        bookmark.setBookmarkType(getString(R.string.para));
